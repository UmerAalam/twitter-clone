...
const SignInPage = () => {
  ...
  return (
    <div className="flex bg-white h-screen justify-center p-1 dark:bg-gray-700">
      <div className="rounded-2xl bg-white py-8 my-auto white shadow-gray-200 dark:bg-gray-800 dark:shadow-gray-600 inset-shadow-2xs shadow-lg h-[520px] w-[400px] font-black">
        ...
        <form>
          <input
            title="Email"
            className="mt-5 focus:outline-blue-400 dark:bg-gray-700 flex justify-center w-[80%] h-12 mx-auto font-medium border border-gray-300 rounded-md p-2"
            placeholder="Email"
            type="email"
            value={email}
